...
def create_pipeline(**kwargs) -> Pipeline:
    return pipeline([
        ...
        node(make_participant_mask, inputs=["raw_vote_matrix", "params:min_votes_threshold"], outputs="participant_filter_mask", name="make_participant_mask"),
        node(make_statement_mask, inputs="raw_comments", outputs="statement_filter_mask", name="make_statement_mask"),
